...
<head>
    ...
    <title>Intercontinental Bankia: <g:layoutTitle default="Grails"/></title>
    ...
    <link href="${assetPath(src: 'sites/all/themes/ebanq/css/bootstrap.min.css')}" rel="stylesheet" type="text/css" media="screen">
